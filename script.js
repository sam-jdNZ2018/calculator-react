...
const CalcButton = props => {
  return (
    React.createElement("button", { id: props.id, className: "calc_but", onClick: () => props.handler(props.value) },
    props.value));
...
class Display extends React.Component {
  ...
  render() {
    return (
      React.createElement("div", { id: "display_cont" },
      React.createElement("input", { id: "eq_display", type: "text", value: this.props.eq, readOnly: true }),
      React.createElement("input", { id: "display", type: "text", value: this.props.curr, readOnly: true })));
...
class Calculator extends React.Component {
  ...
  handleNum(value) {
    ...
    if (OP_REG.test(now) && now.length != this.state.eq.length) {//if the previous button clicked was an operator but was not the first button clicked
      now = value;
    } else
  ...
  render() {
    ...
    return (
      React.createElement("div", { id: "calc_container" },
      React.createElement(Display, { eq: this.state.eq, curr: this.state.curr }),
      React.createElement("div", { id: "button_cont" },
      buttonList)));
